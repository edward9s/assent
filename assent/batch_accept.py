"""Batch publication of several verified work folders in one transaction.
...
folder's stale receipt in dependency order and publishes it through the
unchanged direct ``accept_folder``.
...
from assent.accept import (accept_folder, accept_merge_message, cleanup_warning,
                           dependency_tip)
